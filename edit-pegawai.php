...
if (isset($_POST['simpan'])) {
    ...
    $sql = "UPDATE `karyawan` SET nama = '$nama', alamat = '$alamat', Telepon = '$tlp', password='$pw' WHERE `kode_karyawan`='$kode_karyawan'";
    $result = mysql_query($sql);
   echo $sql;
    ...
    <div class="parlex8-back">
      <div class="w-container">
        <div class="wrap">
          <div class="mainmen">
            <h1 class="mainmen-heading">Edit Pegawai</h1>
      ...
      <div class="control-group">
        <label class="control-label" for="harga"><h3>No. Telepon</h3></label>
          <div class="controls">
            <input type="text" id="harga" name="Telepon" data-provide="typeahead" data-items="4" value="<?php echo $data2['Telepon']?>">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" for="harga"><h3>Password</h3></label>
          <div class="controls">
            <input type="password" id="harga" name="password" data-provide="typeahead" data-items="4" value="<?php echo $data2['password']?>">
        </div>
      </div>
             <br>
           <input class="w-button" type="submit" value="simpan" name="simpan">
           <a href="index.php#Pegawai" class="w-button">Batal</a>
         </form>
         <br><br><br><br><br>
     <br><br>
     </div>
