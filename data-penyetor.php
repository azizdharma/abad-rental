      ...
      <div class="row-fluid sortable">    
        <div class="box span12">
          ...
          <div class="box-content">
            <?php
              $kdPenyetor = $_GET['kode_penyetor'];
              $query = "SELECT * from info_pnytr where kode_penyetor = '$kdPenyetor'";
              $hasil = mysql_query($query);?>
            <table class="table table-striped table-bordered " style="background-color: #16a085">
              <thead>
              ...
              <?php while($data_penyewa = mysql_fetch_array($hasil)){
              ?>
              <tr>
                <td class="center"><?php echo $data_penyewa['kode_penyetor']?></td>
                <td class="center"><?php echo $data_penyewa['nama mobil']?></td>
                <td class="center"><?php echo $data_penyewa['merk']?></td>
              </tr>
              <?php
              }
              ?>
